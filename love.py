...
t.goto(0, -100)
t.color("red")
t.write("Roses are red.", align="center", font=("Arial", 14, "bold"))
t.goto(1, -125)
t.write("Violets are blue.", align="center", font=("Arial", 14, "bold"))
t.goto(2, -150)
t.write("I like coding.", align="center", font=("Arial", 14, "bold"))
t.goto(3, -175)
t.write("Do you do too?", align="center", font=("Arial", 14, "bold"))
